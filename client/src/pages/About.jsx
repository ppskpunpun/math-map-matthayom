...
import nsc from '../assets/nsc_logo.jpg'
  ...
  return (
    <Main>
      ...
      <div className="grid grid-cols-1 gap-3">
        ...
        <div className='py-2 px-8 border-2 border-slate-200'>
          <div className='flex gap-8 items-center'>
            <img className='w-[80px] rounded-full shadow-md' src={nsc} />
            <P mb=''>ต่อมาได้ส่งเข้าแข่งขันในงาน <b>National Software Contest Thailand 27th (2025)</b></P>
          </div>
        </div>
      </div>
      <div className='mt-16'>
